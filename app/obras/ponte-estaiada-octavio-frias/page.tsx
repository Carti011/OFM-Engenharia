        ...
        <header className="rounded-2xl border bg-(--bg-cartao)/90 backdrop-blur-md border-(--borda-principal) shadow-lg shadow-black/20">
          <nav className="px-5 py-2.5 flex items-center justify-between gap-4">
            ...
            <div className="hidden sm:flex items-center gap-1.5 text-xs text-(--texto-suave)">
              ...
              <span className="text-(--texto-principal)">Ponte Estaiada Octávio Frias</span>
            </div>
...
const metricas = [
  ...
  },
  {
    valor: "2",
    unidade: "",
    rotulo: "Ensaios — Estático e Dinâmico",
    icone: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export default function PonteEstaiadaOctavioFriasPage() {
    ...
    <>
      ...
      <main>
        ...
        <section className="relative min-h-[75vh] flex items-end overflow-hidden">
          <Image
            src="/images/Obras/Ponte Estaiada Octávio Frias/Ponte estaida octavio Frias (SP).jpeg"
            alt="Ponte Estaiada Octávio Frias de Oliveira — São Paulo"
            fill
          ...
          <div className="relative z-20 w-full max-w-7xl mx-auto px-6 pb-16 pt-40">
            ...
            <p className="text-sm md:text-base text-white/65 max-w-2xl leading-relaxed">
              Instrumentação completa desde a construção até a inauguração — células de carga em cada estai, PT-100, inclinômetros, LVDTs, anemômetros e acelerômetros. Ensaios estático e dinâmico.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start">
              ...
              >
                ...
                <div className="space-y-5 text-sm text-(--texto-secundario) leading-relaxed">
                  <p>
                    A Ponte Estaiada Octávio Frias de Oliveira recebeu uma das instrumentações mais completas já realizadas em uma obra de infraestrutura no Brasil. O trabalho acompanhou toda a fase de construção até a inauguração, com{" "}
                    <strong className="text-(--texto-principal) font-semibold">seis tipos diferentes de sensores</strong> instalados para monitorar cada aspecto crítico da estrutura.
                  </p>
                  <p>
            ...
            >
              <div className="relative pl-8 border-l-2 border-(--destaque-azul)">
                ...
                <p className="text-base md:text-lg text-(--texto-principal) leading-relaxed mb-6">
                  "Foi um trabalho completo — desde a sua construção até a sua inauguração. Cada estai com{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-2 relative h-72 md:h-105 bg-(--bg-cartao) border border-(--borda-principal) rounded-sm overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-linear-to-t from-black/70 to-transparent">
                  <p className="text-xs text-white/70 tracking-wide">Ponte Estaiada Octávio Frias de Oliveira — São Paulo, SP</p>
                </div>
              </div>
