...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-[#25d366] hover:bg-[#20c05c] rounded-full flex items-center justify-center shadow-lg shadow-[#25d366]/20 transition-all duration-200 hover:scale-110 cursor-pointer group"
    >
      <svg
        width="28"
        height="28"
