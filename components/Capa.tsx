        ...
        <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-6 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4" style={fadeUp(500)}>
              ...
              <a
                href="#servicos"
                className="hidden sm:inline-flex items-center justify-center gap-2 px-8 py-4 border border-(--destaque-azul) text-(--destaque-azul) hover:bg-(--destaque-azul)/10 font-semibold text-base rounded-sm transition-colors duration-200 cursor-pointer"
              >
                Nossos Serviços
              </a>
            </div>
