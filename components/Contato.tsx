      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            <div className="p-6 bg-(--bg-cartao) border border-(--borda-principal) rounded-sm">
              <h3
              ...
              <div className="space-y-5">
                ...
                >
                  <div className="w-9 h-9 bg-(--bg-elemento) border border-(--borda-etiqueta) rounded-sm flex items-center justify-center flex-shrink-0 group-hover:border-(--destaque-azul)/40 transition-colors">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 24 24"
                ...
                <div className="flex items-start gap-4">
                  <div className="w-9 h-9 bg-(--bg-elemento) border border-(--borda-etiqueta) rounded-sm flex items-center justify-center flex-shrink-0">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 24 24"
