...
export default function Contact() {
  ...
  const estiloInput =
    "w-full bg-[#111111] border border-[#222222] focus:border-[#2563eb] outline-none text-white text-sm px-4 py-3 rounded-sm placeholder:text-[#4b5563] transition-colors duration-200";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          >
            Solicitar
            <br />
            <span className="text-[#f97316]">Proposta</span>
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
            ...
            <form onSubmit={aoEnviar} className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label
                    htmlFor="nome"
                    className="block text-xs text-[#6b7280] mb-1.5 uppercase tracking-wide"
                  >
                    Nome *
                  </label>
                  <input
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-[#25d366] hover:bg-[#20c05c] text-white font-bold text-sm rounded-sm transition-colors duration-200 cursor-pointer"
              >
                {/* WhatsApp icon */}
                <svg
                  width="20"
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            <div className="p-6 bg-[#111111] border border-[#1e1e1e] rounded-sm">
              <h3
              ...
              <div className="space-y-5">
                ...
                >
                  <div className="w-9 h-9 bg-[#1a1a1a] border border-[#252525] rounded-sm flex items-center justify-center flex-shrink-0 group-hover:border-[#2563eb]/40 transition-colors">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 24 24"
                  ...
                  <div>
                    <p className="text-xs text-[#6b7280] uppercase tracking-wide mb-0.5">
                      Telefone / WhatsApp
                    </p>
                    <p className="text-white text-sm font-medium group-hover:text-[#93bbff] transition-colors">
                      (11) 96486-6459
                    </p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm font-medium group-hover:text-[#93bbff] transition-colors break-all">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-9 h-9 bg-[#1a1a1a] border border-[#252525] rounded-sm flex items-center justify-center flex-shrink-0">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 24 24"
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 p-5 bg-[#25d366]/10 border border-[#25d366]/20 hover:border-[#25d366]/50 hover:bg-[#25d366]/15 rounded-sm transition-all duration-200 cursor-pointer group"
            >
              <svg
                width="20"
                height="20"
              ...
              <span
                className="text-[#25d366] font-semibold text-sm group-hover:text-white transition-colors"
                style={{ fontFamily: "var(--font-outfit)" }}
              >
