...
export interface BlocoServico {
  ancora: string;           // id do anchor e identificador de navegação
  titulo: string;
  subtitulo: string;
  sobre: string[];
...
export interface ServicoDetalhado {
  ...
  imagemHero?: string;
  galeria?: GaleriaItem[];
  // quando presente, sobrepõe aplicacoes/equipamentos/galeria/obras do nível superior
  tiposDeServico?: BlocoServico[];
}
...
export const servicosDetalhados: ServicoDetalhado[] = [
  // ── 1 ─────────────────────────────────────────────────────
  {
    ...
    acento: "azul",
    subtitulo:
      "Avaliação experimental da capacidade resistente, rigidez e deformabilidade de estruturas — quatro modalidades de ensaio com instrumentação de alta precisão e rastreabilidade técnica.",
    imagemHero: "/images/Obras/Arena Corinthians/capa.jpg",
    sobre: [
      "Os ensaios de prova de carga têm como objetivo verificar experimentalmente o comportamento estrutural sob carregamentos controlados, confrontando os resultados com os limites normativos de segurança e os modelos computacionais de projeto.",
      "A OFM executa quatro modalidades de prova de carga: estática e dinâmica em estruturas civis, hidráulica em reservatórios e lajes, e em sistemas de armazenagem (porta paletes). Em todas elas, a metodologia combina instrumentação de alta precisão com aquisição multicanal em tempo real, garantindo resultados confiáveis e tecnicamente rastreáveis.",
    ],
    metricas: [
      { valor: "4", rotulo: "Modalidades de ensaio" },
      { valor: "Multi", rotulo: "Canal em tempo real" },
      { valor: "FEM", rotulo: "Validação de modelos" },
      { valor: "NBR", rotulo: "6118 / 7188 / 14762" },
    ],
    aplicacoes: [],
    equipamentos: [],
    normas: [
    ...
    obras: [],
    tiposDeServico: [
      // ── Tipo 1: Estática e Dinâmica ──────────────────────────
      {
        ancora: "estatica-dinamica",
        titulo: "Provas de Carga Estáticas e Dinâmicas",
        subtitulo:
          "Avaliação da rigidez, capacidade resistente e deformabilidade de estruturas sob carregamento controlado — strain gages, LVDTs e aquisição multicanal em tempo real.",
        sobre: [
        ...
        aplicacoes: [
          {
            ...
            descricao:
              "Aplicação de carga distribuída controlada nas arquibancadas com monitoramento simultâneo de deformações e deslocamentos. Referência: Arena Corinthians.",
          },
          {
            titulo: "Vagões Ferroviários",
            descricao:
              "Ensaio de desempenho estrutural em vagões do Metrô RJ e CPTM — carregamento simulando condições reais de serviço com passageiros.",
          },
          {
            titulo: "Pontes e Viadutos",
            descricao:
              "Provas de carga com veículos de referência para verificação de rigidez, integridade e segurança operacional de pontes em serviço.",
          },
          {
            titulo: "Passarelas e Estruturas Especiais",
            descricao:
              "Ensaios em estruturas esbeltas com avaliação simultânea de comportamento estático e dinâmico sob cargas controladas.",
          },
        ],
        equipamentos: [
        ...
        galeria: [
          ...
          },
          {
            ...
            legenda:
              "Arena Corinthians — estrutura validada e aprovada antes da inauguração para a Copa 2014",
            destaque: true,
          },
        ],
        obras: [
      ...
      // ── Tipo 2: Hidráulica ───────────────────────────────────
      {
        ...
        subtitulo:
          "Aplicação gradual de carga por lâmina d'água em reservatórios e lajes — strain gages e LVDTs para avaliar rigidez, distribuição de tensões e integridade estrutural.",
        sobre: [
        ...
        aplicacoes: [
          {
            ...
            descricao:
              "Análise do comportamento das vigas radiais sob pressão hidrostática — verificação de distribuição de tensões e integridade estrutural.",
          },
          {
            titulo: "Lajes de Edificações",
            descricao:
              "Simulação das condições reais de uso com lâmina d'água para verificação de rigidez e capacidade de serviço.",
          },
          {
            titulo: "Tanques e Estruturas Hídricas",
            descricao:
              "Ensaios em estruturas destinadas ao armazenamento ou condução de fluidos, com monitoramento de deformações e flechas.",
          },
          {
            titulo: "Validação Pós-Construção",
            descricao:
              "Verificação do desempenho real antes da entrega da obra — confronto dos dados com o modelo estrutural de projeto.",
          },
        ],
        equipamentos: [
      ...
      // ── Tipo 3: Porta Paletes ────────────────────────────────
      {
        ancora: "porta-paletes",
        titulo: "Provas de Carga em Porta Paletes",
        subtitulo:
          "Validação estrutural de sistemas de armazenagem em campo e fábrica — aplicação controlada de carga por etapas com strain gages e LVDTs nas longarinas, conforme ABNT NBR 14762.",
        sobre: [
        ...
        aplicacoes: [
          {
            ...
            descricao:
              "Validação de estruturas já instaladas em operação — carregamento progressivo simulando condições reais com monitoramento contínuo.",
          },
          {
            titulo: "Ensaios em Fábrica",
            descricao:
              "Certificação antes da liberação para uso — carga máxima com 40% de margem de segurança conforme protocolos normativos.",
          },
          {
            titulo: "Sistemas Drive-in e Automatizados",
            descricao:
              "Validação de sistemas de armazenagem especiais com maior complexidade estrutural e requisitos operacionais específicos.",
          },
          {
            titulo: "Inspeção e Alinhamento",
            descricao:
              "Monitoramento dimensional e de alinhamento das estruturas — verificação de plumb, nível e geometria das longarinas.",
          },
        ],
        equipamentos: [
      ...
      // ── Tipo 4: Braços de Porta Paletes ─────────────────────
      {
        ancora: "bracos-porta-paletes",
        titulo: "Ensaio em Braços de Porta Paletes",
        subtitulo:
          "Validação da capacidade resistente e do comportamento estrutural de braços como componentes individuais — ensaio em bancada com célula de carga calibrada, LVDTs e strain gages.",
        sobre: [
        ...
        equipamentos: [
          { nome: "Células de Carga Calibradas", detalhe: "Aplicação e controle da força no braço" },
          { nome: "LVDTs", detalhe: "Deslocamentos verticais e horizontais em tempo real" },
          { nome: "Strain Gages", detalhe: "Deformações nos pontos críticos do componente" },
  ...
  // ── 3 ─────────────────────────────────────────────────────
  {
    ...
    sobre: [
      "Monitorar e validar estruturas são dois lados da mesma exigência técnica: garantir que o comportamento real da estrutura esteja de acordo com o previsto em projeto. A OFM integra esses dois serviços com a mesma base de instrumentação — strain gages, LVDTs e acelerômetros — e a mesma infraestrutura de aquisição multicanal em tempo real.",
      "O monitoramento acompanha a estrutura ao longo do tempo, registrando deformações e deslocamentos em fases críticas de execução ou operação contínua. A validação numérica confronta esses dados experimentais com os resultados do modelo de elementos finitos, confirmando ou corrigindo os parâmetros de cálculo.",
    ],
    metricas: [
      { valor: "24/7", rotulo: "Monitoramento contínuo" },
      { valor: "FEM", rotulo: "Validação de modelos" },
      { valor: "Multi", rotulo: "Canais simultâneos" },
      { valor: "Intl.", rotulo: "Publicações técnicas" },
    ],
    aplicacoes: [],
    equipamentos: [],
    normas: [
    ...
    obras: [],
    tiposDeServico: [
      // ── Tipo 1: Monitoramento Estrutural ────────────────────
      {
        ancora: "monitoramento",
        ...
        sobre: [
          ...
          "A OFM instala sistemas de instrumentação permanente ou temporária com strain gages, LVDTs e acelerômetros, configurados para aquisição multicanal em tempo real. Os dados são processados e apresentados em relatórios periódicos ou em plataforma de visualização contínua.",
          "O serviço é especialmente indicado para obras de grande porte durante fases críticas de execução — concretagem, protensão, cimbramento e descimbramento —, estruturas históricas em processo de requalificação e verificações pós-intervenção.",
        ],
        aplicacoes: [
          {
            titulo: "Obras em Execução",
            descricao:
              "Acompanhamento de fases críticas: concretagem, protensão, cimbramento e descimbramento — verificação contínua dos limites de projeto.",
          },
          {
            titulo: "Pontes e Viadutos",
            descricao:
              "Monitoramento sob tráfego normal para verificação de vida útil, integridade e segurança operacional.",
          },
          {
            titulo: "Estruturas Históricas",
            descricao:
              "Monitoramento de deslocamentos e deformações em edificações de valor patrimonial — detecção precoce de anomalias.",
          },
          {
            titulo: "Estruturas Ferroviárias",
            descricao:
              "Acompanhamento de vagões, estruturas de plataforma e via permanente sob condições reais de operação.",
          },
        ],
        equipamentos: [
          ...
          { nome: "Sistema de Aquisição", detalhe: "Multicanal, tempo real, 24/7" },
        ],
        normas: ["ABNT NBR 6118", "ABNT NBR 6120", "ISO 13822"],
        galeria: [],
        obras: [
      ...
      // ── Tipo 2: Validação de Modelos Numéricos ───────────────
      {
        ancora: "validacao-numerica",
        titulo: "Validação de Modelos Numéricos (FEM)",
        subtitulo:
          "Calibração experimental de simulações em elementos finitos — correlacionando dados de campo com modelos computacionais para confirmar o comportamento estrutural real.",
        sobre: [
          ...
          "A OFM instrumenta as estruturas durante as fases mais representativas do carregamento e registra deformações, tensões e deslocamentos com alta precisão. Esses dados são então comparados com os resultados do modelo de elementos finitos (FEM), permitindo calibrar os parâmetros do modelo e confirmar ou refutar as hipóteses de projeto.",
          "A excelente correlação entre dados experimentais e numéricos transforma a instrumentação de um simples ensaio em uma ferramenta de engenharia de alta precisão — como demonstrado no descimbramento do Museu do Amanhã, cujos resultados foram citados em publicação técnica internacional.",
        ],
        aplicacoes: [
          {
            titulo: "Estruturas Metálicas",
            descricao:
              "Validação de modelos FEM para estruturas em aço com geometrias complexas e comportamento não linear.",
          },
          {
            titulo: "Concreto Armado e Protendido",
            descricao:
              "Calibração de modelos para estruturas de concreto em fases críticas de execução e operação.",
          },
          {
            titulo: "Obras de Referência Nacional",
            descricao:
              "Validação experimental em estruturas de grande porte com requisitos técnicos elevados e documentação para publicação.",
          },
          {
            titulo: "Suporte a Pesquisa Técnica",
            descricao:
              "Dados experimentais rastreáveis para suporte a artigos científicos, dissertações e trabalhos de pesquisa em engenharia estrutural.",
          },
        ],
        equipamentos: [
  ...
  // ── 6 ─────────────────────────────────────────────────────
  {
    ...
    sobre: [
      "Os ensaios industriais da OFM cobrem quatro especialidades complementares: verificação de desempenho em componentes pneumáticos, fabricação e calibração de células de carga sob medida, verificação de soldas estruturais e monitoramento térmico para segurança contra incêndio.",
      "Em todos os casos, a metodologia combina instrumentação de alta precisão com aquisição em tempo real e rastreabilidade metrológica, entregando dados confiáveis, laudos técnicos detalhados e conformidade com as normas brasileiras e internacionais aplicáveis.",
    ],
    metricas: [
      { valor: "RBC", rotulo: "Rastreabilidade" },
      { valor: "Real", rotulo: "Aquisição em tempo real" },
      { valor: "Alta", rotulo: "Resolução metrológica" },
      { valor: "4", rotulo: "Especialidades industriais" },
    ],
    aplicacoes: [],
    equipamentos: [],
    normas: [
    ...
    obras: [],
    tiposDeServico: [
      // ── Tipo 1: Cilindros Pneumáticos ────────────────────────
      {
        ancora: "cilindros-pneumaticos",
        titulo: "Ensaios em Cilindros Pneumáticos e Componentes",
        subtitulo:
        ...
        aplicacoes: [
          {
            ...
            descricao:
              "Verificação de torque, desempenho e integridade estrutural sob esforços cíclicos reproduzindo condições reais de operação.",
          },
          {
            titulo: "Pistões e Atuadores",
            descricao:
              "Validação experimental de pistões e atuadores — identificação de falhas prematuras e não conformidades com especificações do fabricante.",
          },
          {
            titulo: "Sistemas Eletropneumáticos",
            descricao:
              "Ensaios com circuito automatizado de controle eletropneumático e temporizador, simulando ciclos reais de trabalho.",
          },
          {
            titulo: "Controle de Qualidade Industrial",
            descricao:
              "Certificação e validação de componentes para aplicações industriais e automotivas com dados rastreáveis e laudo técnico.",
          },
        ],
        equipamentos: [
      ...
      // ── Tipo 2: Células de Carga ─────────────────────────────
      {
        ancora: "celulas-de-carga",
        ...
        sobre: [
          ...
          "A capacidade de produzir células customizadas é um diferencial competitivo da OFM — permite executar ensaios que outras empresas não conseguem instrumentar, seja por restrições de espaço, força, temperatura ou geometria do ponto de medição.",
        ],
        aplicacoes: [
          {
            titulo: "Células para Provas de Carga",
            descricao:
              "Transdutores com faixa e geometria adequadas para ensaios estruturais em pontes, arquibancadas e sistemas de armazenagem.",
          },
          {
            titulo: "Células para Sistemas de Medição",
            descricao:
              "Produção para sistemas de pesagem, monitoramento de força e controle de processos industriais.",
          },
          {
            titulo: "Geometrias Especiais",
            descricao:
              "Designs customizados para espaços confinados, condições extremas ou requisitos geométricos não atendidos por transdutores comerciais.",
          },
          {
            titulo: "Calibração e Aferição",
            descricao:
              "Calibração de células existentes com rastreabilidade INMETRO/RBC — verificação de linearidade, histerese e sensibilidade.",
          },
        ],
        equipamentos: [
      ...
      // ── Tipo 3: Arrancamento e Soldas ────────────────────────
      {
        ancora: "arrancamento-soldas",
        titulo: "Arrancamento e Verificação de Soldas Estruturais",
        subtitulo:
          "Avaliação da resistência à tração, integridade e desempenho mecânico de soldas em barras de ancoragem, chapas metálicas e componentes estruturais — carregamento controlado com macaco hidráulico calibrado.",
        sobre: [
          ...
          "O carregamento é aplicado de forma controlada por meio de macaco hidráulico calibrado. Os dados adquiridos possibilitam a geração de gráficos de carga versus deformação e carga versus deslocamento, fundamentais para determinar o comportamento da solda até o ponto de ruptura ou escoamento.",
          "A OFM fornece relatórios técnicos completos com análise gráfica, resultados precisos e rastreáveis. Os ensaios seguem as normas AWS D1.1/D1.1M ou as normas brasileiras equivalentes ABNT NBR 6492 e ABNT NBR 8800, conforme a tipologia estrutural e o processo de soldagem.",
        ],
        aplicacoes: [
          {
            titulo: "Barras de Ancoragem",
            descricao:
              "Verificação da resistência à tração de chumbadores, tirantes e ancoragens estruturais fixados em concreto ou aço.",
          },
          {
            titulo: "Chapas e Ligações Metálicas",
            descricao:
              "Avaliação da integridade de soldas em chapas de ligação, placas de base e nós estruturais.",
          },
          {
            titulo: "Validação de Processos de Soldagem",
            descricao:
              "Qualificação experimental de procedimentos de soldagem — determinação da resistência real dos cordões executados.",
          },
          {
            titulo: "Reforços e Reparos Estruturais",
            descricao:
              "Ensaios em soldas de intervenções de reforço e reparo — verificação do desempenho mecânico pós-execução.",
          },
        ],
        equipamentos: [
      ...
      // ── Tipo 4: Monitoramento Térmico ────────────────────────
      {
        ancora: "monitoramento-termico",
        titulo: "Monitoramento Térmico e Detecção de Fumaça",
        subtitulo:
          "Ensaios de estudo de fuga de fumaça com sensores PT100 posicionados estrategicamente em pontos críticos — detecção precoce de variações térmicas e integração com sistemas de alarme.",
        sobre: [
        ...
        aplicacoes: [
          {
            ...
            descricao:
              "Ensaios em grandes estruturas com pé-direito elevado — posicionamento de sensores via plataforma elevatória para cobertura de toda a área.",
          },
          {
            titulo: "Ambientes Comerciais",
            descricao:
              "Verificação da eficácia do sistema de detecção e evacuação de fumaça em shoppings, arenas e edificações com público.",
          },
          {
            titulo: "Integração com Alarmes",
            descricao:
              "Validação da resposta automática dos sistemas de alarme e supressão de incêndio a partir das leituras térmicas dos sensores.",
          },
          {
            titulo: "Adequação Normativa",
            descricao:
              "Ensaios para certificação e conformidade com as normas de segurança contra incêndio vigentes.",
          },
        ],
        equipamentos: [
  ...
  // ── 8 ─────────────────────────────────────────────────────
  {
    ...
    subtitulo:
      "Identificação experimental de frequências naturais, modos de vibração e coeficientes de amortecimento — em estruturas civis, edifícios, vias públicas, máquinas e equipamentos industriais.",
    sobre: [
      "A análise de vibração tem como objetivo preservar o conforto humano e garantir a integridade de estruturas e equipamentos submetidos a excitações dinâmicas. Vibrações excessivas podem causar desde desconforto aos usuários até falhas prematuras por fadiga.",
      "A OFM executa ensaios em dois contextos complementares: em estruturas civis — onde o foco é o conforto humano e a conformidade com os limites normativos — e em máquinas e equipamentos industriais, onde o diagnóstico de ressonância e o monitoramento de frequências previnem falhas e perdas de desempenho.",
      "Em ambos os casos, a metodologia combina acelerômetros de alta sensibilidade, aquisição multicanal em tempo real e processamento espectral (FFT e análise modal), entregando resultados rastreáveis e fundamentados tecnicamente.",
    ],
    metricas: [
      { valor: "Hz", rotulo: "Frequências naturais" },
      { valor: "Modal", rotulo: "Análise experimental" },
      { valor: "FFT", rotulo: "Processamento espectral" },
      { valor: "NBR", rotulo: "6118 / ISO 10816" },
    ],
    aplicacoes: [],
    equipamentos: [],
    normas: [
    ...
    obras: [],
    tiposDeServico: [
      // ── Tipo 1: Conforto Humano e Estruturas ────────────────
      {
        ancora: "conforto-estrutural",
        titulo: "Vibração em Estruturas e Conforto Humano",
        subtitulo:
          "Avaliação de vibrações em edifícios, pontes, passarelas, arquibancadas e vias públicas — identificação de frequências naturais, amortecimentos e conformidade com os limites normativos de conforto.",
        sobre: [
          "Estruturas sujeitas a cargas dinâmicas — vento, tráfego, uso humano sincronizado — podem apresentar vibrações incômodas ou até perigosas. A OFM avalia o comportamento dinâmico real dessas estruturas e verifica a conformidade com os limites normativos de conforto.",
          "Os ensaios de análise modal experimental identificam as frequências naturais e coeficientes de amortecimento da estrutura. Esses parâmetros são comparados com os limites estabelecidos pelas normas ABNT NBR 6118 e NBR 7188 e utilizados para calibrar os modelos computacionais de projeto.",
          "O serviço atende estruturas residenciais e comerciais com queixas de vibração perceptível, pontes e viadutos com solicitação de tráfego pesado, passarelas esbeltas, arquibancadas e estruturas de eventos, além de vias públicas com impacto sobre edificações vizinhas.",
          "Os resultados fornecem a base técnica para projetos de atenuação de vibração, reforços estruturais e, quando necessário, instalação e aferição de dispositivos de controle dinâmico (ADS).",
        ],
        aplicacoes: [
          {
            titulo: "Edifícios Residenciais e Comerciais",
            descricao:
              "Diagnóstico de vibração perceptível em lajes, pisos e estruturas de concreto — identificação da fonte, frequência e conformidade com os limites de conforto.",
          },
          {
            titulo: "Pontes, Viadutos e Vias Públicas",
            descricao:
              "Avaliação de conforto veicular, resposta ao tráfego pesado e impacto de vibrações transmitidas às edificações lindeiras.",
          },
          {
            titulo: "Passarelas e Estruturas Esbeltas",
            descricao:
              "Análise de conforto humano em estruturas sensíveis à excitação por pedestres — verificação de frequências críticas e amortecimento.",
          },
          {
            titulo: "Arquibancadas e Estruturas de Eventos",
            descricao:
              "Ensaios dinâmicos em estruturas com uso coletivo e excitação rítmica — validação da segurança e conforto durante ocupação.",
          },
        ],
        equipamentos: [
      ...
      // ── Tipo 2: Máquinas e Equipamentos ─────────────────────
      {
        ancora: "maquinas-equipamentos",
        titulo: "Vibração em Máquinas e Equipamentos",
        subtitulo:
          "Identificação de frequências de ressonância e modos de vibração em máquinas rotativas, compressores, bombas e estruturas de apoio — processamento espectral em tempo real para diagnóstico e prevenção de falhas.",
        sobre: [
          "O Ensaio de Análise de Vibração em Máquinas e Equipamentos tem como objetivo identificar e quantificar as frequências de ressonância e modos de vibração de equipamentos industriais e suas estruturas de apoio, garantindo desempenho estável, seguro e dentro das faixas de operação projetadas.",
          "Durante o ensaio, acelerômetros de alta sensibilidade são instalados nos pontos estratégicos do equipamento e na estrutura adjacente — como lajes, bases de fundação e suportes — permitindo separar as componentes estruturais das operacionais da vibração.",
          "A OFM realiza a aquisição em alta taxa de amostragem com processamento espectral (FFT) em tempo real, determinando com precisão as frequências dominantes (Hz), amplitudes e modos de resposta dinâmica. Com esses dados é possível diagnosticar fontes de vibração excessiva, avaliar risco de ressonância e propor medidas corretivas.",
        ],
        aplicacoes: [
          {
            titulo: "Máquinas Rotativas e Compressores",
            descricao:
              "Diagnóstico de vibração excessiva em máquinas rotativas, compressores, bombas e equipamentos com base de fundação — identificação de desbalanceamento e ressonância.",
          },
          {
            titulo: "Estruturas de Apoio e Fundações",
            descricao:
              "Separação das componentes estruturais e operacionais de vibração em lajes, bases e suportes de equipamentos industriais.",
          },
          {
            titulo: "Avaliação de Risco de Ressonância",
            descricao:
              "Identificação de frequências naturais próximas às frequências de operação — prevenção de ressonância e falha por fadiga em equipamentos e estruturas.",
          },
          {
            titulo: "Medidas Corretivas e Otimização",
            descricao:
              "Proposição de alterações de rigidez, isolamento dinâmico ou ajuste de parâmetros operacionais para redução de vibrações e aumento da vida útil.",
          },
        ],
        equipamentos: [
          ...
          { nome: "Processamento Espectral FFT", detalhe: "Análise em tempo real" },
  ...
  // ── 10 ────────────────────────────────────────────────────
  {
    ...
    subtitulo:
      "Validação experimental estática e dinâmica de estruturas fixas e móveis — torres, pontes, viadutos, instalações de eventos e equipamentos de grande porte em deslocamento.",
    sobre: [
      "Os ensaios em estruturas têm como objetivo verificar experimentalmente a integridade, a rigidez e o comportamento dinâmico de instalações sob condições reais de carregamento. A OFM atua em dois contextos complementares: estruturas fixas — pontes, torres, viadutos e instalações de eventos — e estruturas móveis sujeitas a solicitações dinâmicas durante o transporte.",
      "Em ambos os casos, a metodologia combina instrumentação de alta precisão com aquisição multicanal em tempo real, entregando laudos técnicos rastreáveis que comprovam a conformidade com as normas vigentes.",
    ],
    metricas: [
    ...
    obras: [],
    tiposDeServico: [
      // ── Tipo 1: Torres, Pontes e Estruturas Especiais ───────
      {
        ancora: "estruturas-fixas",
        titulo: "Ensaios Estáticos e Dinâmicos em Estruturas Fixas",
        subtitulo:
          "Validação experimental de torres, pontes, viadutos e instalações temporárias — acelerômetros triaxiais, strain gages e LVDTs integrados ao sistema Lynx ADS2000.",
        sobre: [
          "Os ensaios estáticos e dinâmicos em estruturas fixas têm como objetivo a validação experimental do comportamento estrutural de instalações temporárias e permanentes, assegurando segurança, desempenho e conformidade técnica. Esses ensaios avaliam a resposta real das estruturas sob ação de cargas estáticas controladas e excitações dinâmicas, garantindo estabilidade, rigidez e resposta vibratória dentro dos limites normativos.",
          "Durante o evento The Town 2025, a OFM executou o ensaio estrutural completo da torre da tirolesa, aplicando metodologia de instrumentação de alta precisão com strain gages, LVDTs e acelerômetros triaxiais integrados ao sistema de aquisição Lynx ADS2000. O processamento e a análise foram realizados pelo software AqDados e AqDAnalysis, assegurando a integridade estrutural da instalação durante todo o período do evento.",
          "A mesma metodologia é aplicada em pontes, passarelas, viadutos e torres metálicas, atendendo às normas ABNT NBR 8800 para estruturas de aço e ABNT NBR 6118 para estruturas de concreto. Cada ensaio é documentado em relatório técnico completo com resultados, análises e diagnóstico estrutural.",
        ],
        aplicacoes: [
          {
            titulo: "Torres e Estruturas de Eventos",
            descricao:
              "Validação de torres temporárias, estruturas de palco e instalações especiais — como a torre da tirolesa do The Town 2025.",
          },
          {
            titulo: "Pontes e Passarelas",
            descricao:
              "Ensaios estáticos e dinâmicos sob cargas controladas — verificação de rigidez, deslocamentos e resposta em frequência.",
          },
          {
            titulo: "Viadutos e Estruturas Urbanas",
            descricao:
              "Avaliação de desempenho estrutural e resposta dinâmica em viadutos e estruturas de infraestrutura urbana.",
          },
          {
            titulo: "Torres Metálicas",
            descricao:
              "Validação experimental sob cargas estáticas e excitações dinâmicas — análise modal e verificação de estabilidade.",
          },
        ],
        equipamentos: [
          ...
          { nome: "AqDados / AqDAnalysis", detalhe: "Processamento e análise espectral" },
        ],
        normas: ["ABNT NBR 8800", "ABNT NBR 6118"],
        galeria: [],
        obras: [
          {
            titulo: "Torre da Tirolesa — The Town 2025",
            local: "São Paulo, SP",
      ...
      // ── Tipo 2: Trafegabilidade ──────────────────────────────
      {
        ancora: "trafegabilidade",
        ...
        sobre: [
          "O ensaio de trafegabilidade tem como objetivo avaliar a integridade estrutural e o comportamento dinâmico da carreta que transporta a subestação móvel, garantindo que a unidade possa trafegar com segurança e confiabilidade entre cidades.",
        ...
        aplicacoes: [
          {
            ...
            descricao:
              "Strain gages nos pontos críticos definidos por FEM. Verificação de deformações e tensões dentro do limite de 70% da tensão de escoamento.",
          },
          {
            titulo: "Subestação Montada — Fase 2",
            descricao:
              "Acelerômetros em para-raios, isoladores, trocadores de calor e suportes. Monitoramento de vibrações durante o deslocamento real.",
          },
          {
            titulo: "Componentes Críticos",
            descricao:
              "Validação de que nenhum componente da subestação se desprende ou falha estruturalmente durante o percurso entre cidades.",
          },
          {
            titulo: "Subestações Móveis de Grande Porte",
            descricao:
              "Ensaios em unidades industriais de grande porte com metodologia de duas fases e análise integrada de estrutura e equipamentos.",
          },
        ],
        equipamentos: [
